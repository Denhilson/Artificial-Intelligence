...
private:
    ...
    void computerInput(){
        ...
        if(emptyIndex[pos] == 1){
            ...
            cout<< "Computer Memilih: " << pos+1 << endl;
            emptyIndex[pos] =1;
            emptyCount-=1;
            board[pos] = 'O';
        }
    ...
    void playerInput(Player &player){
        int pos;
        cout << endl;
        cout << "\t" << player.getName() <<" Memilih: ";
        cout <<"\t Enter Jika Sudah " << endl;
        cin >> pos;
        pos -=1;
        if(emptyIndex[pos] == 1){
...
int main()
{
    ...
    while(1){
        cout<< "      ----------Pilihan----------" << endl;
        cout << "\t 1. 1 Pemain Satu" <<endl;
        cout << "\t 2. 2 Pemain Dua " <<endl;
        cout << "\t 3. To exit " <<endl;
        cout <<"      ------------------------" << endl;
        cout << endl;
